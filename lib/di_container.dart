...
import 'package:mstore/features/address/domain/repositories/address_repository_interface.dart';
import 'package:mstore/features/address/domain/services/address_service.dart';
import 'package:mstore/features/address/domain/services/address_service_interface.dart';
import 'package:mstore/features/auth/controllers/facebook_login_controller.dart';
import 'package:mstore/features/auth/controllers/google_login_controller.dart';
import 'package:mstore/features/auth/domain/repositories/auth_repository.dart';
import 'package:mstore/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:mstore/features/auth/domain/services/auth_service.dart';
import 'package:mstore/features/auth/domain/services/auth_service_interface.dart';
import 'package:mstore/features/banner/controllers/banner_controller.dart';
import 'package:mstore/features/banner/domain/repositories/banner_repository.dart';
import 'package:mstore/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:mstore/features/banner/domain/services/banner_service.dart';
import 'package:mstore/features/banner/domain/services/banner_service_interface.dart';
import 'package:mstore/features/brand/domain/repositories/brand_repo_interface.dart';
import 'package:mstore/features/brand/domain/repositories/brand_repository.dart';
import 'package:mstore/features/brand/domain/services/brand_service.dart';
import 'package:mstore/features/brand/domain/services/brand_service_interface.dart';
import 'package:mstore/features/cart/domain/repositories/cart_repository.dart';
import 'package:mstore/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:mstore/features/cart/domain/services/cart_service.dart';
import 'package:mstore/features/cart/domain/services/cart_service_interface.dart';
import 'package:mstore/features/category/domain/repositories/category_repo.dart';
import 'package:mstore/features/category/domain/repositories/category_repo_interface.dart';
import 'package:mstore/features/category/domain/services/category_service.dart';
import 'package:mstore/features/category/domain/services/category_service_interface.dart';
import 'package:mstore/features/chat/domain/repositories/chat_repository.dart';
import 'package:mstore/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:mstore/features/chat/domain/services/chat_service.dart';
import 'package:mstore/features/chat/domain/services/chat_service_interface.dart';
import 'package:mstore/features/checkout/controllers/checkout_controller.dart';
import 'package:mstore/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:mstore/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:mstore/features/checkout/domain/services/checkout_service.dart';
import 'package:mstore/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:mstore/features/compare/controllers/compare_controller.dart';
import 'package:mstore/features/compare/domain/repositories/compare_repository.dart';
import 'package:mstore/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:mstore/features/compare/domain/services/compare_service.dart';
import 'package:mstore/features/compare/domain/services/compare_service_interface.dart';
import 'package:mstore/features/contact_us/controllers/contact_us_controller.dart';
import 'package:mstore/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:mstore/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:mstore/features/contact_us/domain/services/contact_us_service.dart';
import 'package:mstore/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:mstore/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:mstore/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:mstore/features/coupon/domain/services/coupon_service.dart';
import 'package:mstore/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:mstore/features/address/domain/repositories/address_repository.dart';
import 'package:mstore/features/deal/controllers/featured_deal_controller.dart';
import 'package:mstore/features/deal/controllers/flash_deal_controller.dart';
import 'package:mstore/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:mstore/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:mstore/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:mstore/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:mstore/features/deal/domain/services/featured_deal_service.dart';
import 'package:mstore/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:mstore/features/deal/domain/services/flash_deal_service.dart';
import 'package:mstore/features/deal/domain/services/flash_deal_service_interface.dart';
import 'package:mstore/features/location/controllers/location_controller.dart';
import 'package:mstore/features/location/domain/repositories/location_repository.dart';
import 'package:mstore/features/location/domain/repositories/location_repository_interface.dart';
import 'package:mstore/features/location/domain/services/location_service.dart';
import 'package:mstore/features/location/domain/services/location_service_interface.dart';
import 'package:mstore/features/loyaltyPoint/controllers/loyalty_point_controller.dart';
import 'package:mstore/features/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:mstore/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
import 'package:mstore/features/loyaltyPoint/domain/services/loyalty_point_service_interface.dart';
import 'package:mstore/features/notification/controllers/notification_controller.dart';
import 'package:mstore/features/notification/domain/repositories/notification_repository.dart';
import 'package:mstore/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:mstore/features/notification/domain/services/notification_service.dart';
import 'package:mstore/features/notification/domain/services/notification_service_interface.dart';
import 'package:mstore/features/onboarding/controllers/onboarding_controller.dart';
import 'package:mstore/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:mstore/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:mstore/features/onboarding/domain/services/onboarding_service.dart';
import 'package:mstore/features/onboarding/domain/services/onboarding_service_interface.dart';
import 'package:mstore/features/order/controllers/order_controller.dart';
import 'package:mstore/features/order/domain/repositories/order_repository.dart';
import 'package:mstore/features/order/domain/repositories/order_repository_interface.dart';
import 'package:mstore/features/order/domain/services/order_service.dart';
import 'package:mstore/features/order/domain/services/order_service_interface.dart';
import 'package:mstore/features/order_details/controllers/order_details_controller.dart';
import 'package:mstore/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:mstore/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:mstore/features/order_details/domain/services/order_details_service.dart';
import 'package:mstore/features/order_details/domain/services/order_details_service_interface.dart';
import 'package:mstore/features/product/controllers/product_controller.dart';
import 'package:mstore/features/product/controllers/seller_product_controller.dart';
import 'package:mstore/features/product/domain/repositories/product_repository.dart';
import 'package:mstore/features/product/domain/repositories/product_repository_interface.dart';
import 'package:mstore/features/product/domain/repositories/seller_product_repository.dart';
import 'package:mstore/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:mstore/features/product/domain/services/product_service.dart';
import 'package:mstore/features/product/domain/services/product_service_interface.dart';
import 'package:mstore/features/product/domain/services/seller_product_service.dart';
import 'package:mstore/features/product/domain/services/seller_product_service_interface.dart';
import 'package:mstore/features/product_details/controllers/product_details_controller.dart';
import 'package:mstore/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:mstore/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:mstore/features/product_details/domain/services/product_details_service.dart';
import 'package:mstore/features/product_details/domain/services/product_details_service_interface.dart';
import 'package:mstore/features/profile/controllers/profile_contrroller.dart';
import 'package:mstore/features/profile/domain/repositories/profile_repository.dart';
import 'package:mstore/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:mstore/features/profile/domain/services/profile_service.dart';
import 'package:mstore/features/profile/domain/services/profile_service_interface.dart';
import 'package:mstore/features/refund/controllers/refund_controller.dart';
import 'package:mstore/features/refund/domain/repositories/refund_repository.dart';
import 'package:mstore/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:mstore/features/refund/domain/services/refund_service.dart';
import 'package:mstore/features/refund/domain/services/refund_service_interface.dart';
import 'package:mstore/features/reorder/controllers/re_order_controller.dart';
import 'package:mstore/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:mstore/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:mstore/features/reorder/domain/services/re_order_service.dart';
import 'package:mstore/features/reorder/domain/services/re_order_service_interface.dart';
import 'package:mstore/features/review/controllers/review_controller.dart';
import 'package:mstore/features/review/domain/repositories/review_repository.dart';
import 'package:mstore/features/review/domain/repositories/review_repository_interface.dart';
import 'package:mstore/features/review/domain/services/review_service.dart';
import 'package:mstore/features/review/domain/services/review_service_interface.dart';
import 'package:mstore/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:mstore/features/search_product/domain/services/search_product_service.dart';
import 'package:mstore/features/search_product/domain/services/search_product_service_interface.dart';
import 'package:mstore/features/shipping/controllers/shipping_controller.dart';
import 'package:mstore/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:mstore/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:mstore/features/shipping/domain/services/shipping_service.dart';
import 'package:mstore/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:mstore/features/shop/domain/repositories/shop_repository.dart';
import 'package:mstore/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:mstore/features/shop/domain/services/shop_service.dart';
import 'package:mstore/features/shop/domain/services/shop_service_interface.dart';
import 'package:mstore/features/splash/controllers/splash_controller.dart';
import 'package:mstore/features/splash/domain/repositories/splash_repository.dart';
import 'package:mstore/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:mstore/features/splash/domain/services/splash_service.dart';
import 'package:mstore/features/splash/domain/services/splash_service_interface.dart';
import 'package:mstore/features/support/controllers/support_ticket_controller.dart';
import 'package:mstore/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:mstore/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:mstore/features/support/domain/services/support_ticket_service.dart';
...
import 'package:mstore/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:mstore/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:mstore/features/wallet/domain/services/wallet_service.dart';
import 'package:mstore/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:mstore/features/wishlist/controllers/wishlist_controller.dart';
import 'package:mstore/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:mstore/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:mstore/features/wishlist/domain/services/wishlist_service.dart';
import 'package:mstore/features/wishlist/domain/services/wishlist_service_interface.dart';
import 'package:mstore/helper/network_info.dart';
import 'package:mstore/features/auth/controllers/auth_controller.dart';
import 'package:mstore/features/brand/controllers/brand_controller.dart';
import 'package:mstore/features/cart/controllers/cart_controller.dart';
import 'package:mstore/features/category/controllers/category_controller.dart';
import 'package:mstore/features/chat/controllers/chat_controller.dart';
import 'package:mstore/features/coupon/controllers/coupon_controller.dart';
import 'package:mstore/localization/controllers/localization_controller.dart';
import 'package:mstore/features/address/controllers/address_controller.dart';
import 'package:mstore/features/search_product/controllers/search_product_controller.dart';
import 'package:mstore/features/shop/controllers/shop_controller.dart';
import 'package:mstore/theme/controllers/theme_controller.dart';
