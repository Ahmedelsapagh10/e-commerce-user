...
import 'package:mstore/common/basewidget/custom_loader_widget.dart';
import 'package:mstore/features/brand/domain/models/brand_model.dart';
import 'package:mstore/features/category/domain/models/category_model.dart';
import 'package:mstore/features/product/controllers/seller_product_controller.dart';
import 'package:mstore/features/search_product/domain/models/author_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      child: Consumer<SearchProductController>(
        ...
        late List<AuthorModel>? authorList = widget.fromShop
            ? Provider.of<SearchProductController>(context, listen: false)
                .sellerAuthorsList
            : Provider.of<SearchProductController>(context, listen: false)
                .authorsList;

        late List<AuthorModel>? publishingHouse = widget.fromShop
            ? Provider.of<SearchProductController>(context, listen: false)
                .sellerPublishingHouseList
            : Provider.of<SearchProductController>(context, listen: false)
                .publishingHouseList;
                    ...
                    Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            (categoryProvider.selectedCategoryIds.isNotEmpty ||
                                    brandProvider.selectedBrandIds.isNotEmpty ||
                                    (widget.fromShop
                                        ? searchProvider
                                            .sellerPublishingHouseIds.isNotEmpty
                                        : searchProvider
                                            .publishingHouseIds.isNotEmpty) ||
                                    (widget.fromShop
                                        ? searchProvider
                                            .selectedSellerAuthorIds.isNotEmpty
                                        : searchProvider
                                ...
                                ? InkWell(
                                    onTap: () async {
                                      ...
                                      await categoryProvider.resetChecked(
                                          widget.fromShop
                                              ? widget.sellerId!
                                              : null,
                                          widget.fromShop);
                                      ...
                                      searchProvider.selectedSellerAuthorIds
                                          .clear();
                                      searchProvider.sellerPublishingHouseIds
                                          .clear();
                                      searchProvider.publishingHouseIds.clear();
                                      searchProvider.selectedAuthorIds.clear();
                                      searchProvider.resetChecked(
                                          widget.sellerId ?? null,
                                          widget.fromShop);
                                      Provider.of<SearchProductController>(
                                              context,
                                              listen: false)
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          onChanged: (value) {
                                            searchProvider.setProductTypeIndex(
                                                value == 'all_product_search'
                                                    ? 0
                                                    : value == 'physical'
                                                        ? 1
                                                        : 2,
                            ...
                            // Brand
                            if (searchProvider.productTypeIndex == 0 ||
                            ...
                            if ((publishingHouse != null &&
                              ...
                              const SizedBox(
                                  height: Dimensions.paddingSizeSmall),
                              Text(
                                  getTranslated('publishing_house', context) ??
                                      '',
                                  style: titilliumSemiBold.copyWith(
                                      fontSize: Dimensions.fontSizeLarge)),
                              const SizedBox(
                    ...
                    Padding(
                      ...
                      child: CustomButton(
                        ...
                        onTap: brandProvider.selectedBrandIds.isEmpty &&
                                ...
                                (widget.fromShop
                                    ? searchProvider
                                            .selectedSellerAuthorIds.isEmpty &&
                                        searchProvider
                                            .sellerPublishingHouseIds.isEmpty
                                    : searchProvider
                                            .selectedAuthorIds.isEmpty &&
                                        searchProvider
                                            .publishingHouseIds.isEmpty) &&
                                (searchProvider.productTypeIndex != 0 &&
                                    searchProvider.productTypeIndex != 1 &&
                                    searchProvider.productTypeIndex != 2)
                            ? null
                            : () {
                                ...
                                if (searchProvider.productTypeIndex == 1 &&
                                    selectedCategoryIdsList.isEmpty &&
                                  ...
                                  showCustomSnackBar(
                                      ...
                                      context,
                                      isToaster: true);
                                } else if (searchProvider.productTypeIndex ==
                                        2 &&
                                    ((searchProvider
                                                .selectedAuthorIds.isEmpty &&
                                            searchProvider
                                    ...
                                    searchProvider.productTypeIndex == 0) {
                                  showCustomSnackBar(
                                      '${getTranslated('select_author_or_publishing_first', context)}',
                                      context,
                                      isToaster: true);
                                } else {
                                  ...
                                  String selectedAuthorId = widget.fromShop
                                      ? searchProvider.selectedSellerAuthorIds
                                              .isNotEmpty
                                          ? jsonEncode(searchProvider
                                              .selectedSellerAuthorIds)
                                          : '[]'
                                      : searchProvider
                                              .selectedAuthorIds.isNotEmpty
                                          ? jsonEncode(
                                              searchProvider.selectedAuthorIds)
                                          : '[]';
                                  String selectedPublishingId = widget.fromShop
                                      ...
                                      : searchProvider
                                              .publishingHouseIds.isNotEmpty
                                          ? jsonEncode(
                                              searchProvider.publishingHouseIds)
                                          : '[]';
