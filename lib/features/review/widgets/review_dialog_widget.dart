...
class _ReviewDialogState extends State<ReviewDialog> {
  ...
  Future<void> loadData() async {
    await Provider.of<ReviewController>(Get.context!, listen: false)
        .getOrderWiseReview(widget.productID, widget.orderId);
    if (Provider.of<ReviewController>(Get.context!, listen: false)
            .orderWiseReview !=
        null) {
      Provider.of<ReviewController>(Get.context!, listen: false).setRating(
          Provider.of<ReviewController>(Get.context!, listen: false)
              .orderWiseReview!
              .rating!);
      _controller.text =
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (reviewController.orderWiseReview != null &&
                        reviewController.orderWiseReview!.attachmentFullUrl !=
                            null &&
                        reviewController
                            .orderWiseReview!.attachmentFullUrl!.isNotEmpty)
                      Padding(
                          ...
                          child: SizedBox(
                              ...
                              child: ListView.builder(
                                  shrinkWrap: true,
                                  scrollDirection: Axis.horizontal,
                                  itemCount: reviewController.orderWiseReview
                                      ?.attachmentFullUrl?.length,
                                          ...
                                          child: Container(
                                              ...
                                              child: ClipRRect(
                                                  ...
                                                  child: CustomImageWidget(
                                                    image:
                                                        "${reviewController.orderWiseReview?.attachmentFullUrl?[index].path}",
                                                  )))),
                                      Positioned(
                                          top: 0,
                                          right: 0,
                                  ...
                                  return index ==
                                      ...
                                      : Stack(children: [
                                          ...
                                          Positioned(
                                              ...
                                              right: 0,
                                              child: InkWell(
                                                  onTap: () => reviewController.removeImage(
                                                      index,
                                                      fromReview: true),
                                                  child: Container(
                                                      decoration: const BoxDecoration(
                          ...
                          onTap: () {
                            if (reviewController.rating == 0) {
                              ...
                              ReviewBody reviewBody = ReviewBody(
                                  id: reviewController.orderWiseReview?.id
                                      .toString(),
