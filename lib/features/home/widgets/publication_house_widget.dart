  ...
  Widget build(BuildContext context) {
    return Consumer<SearchProductController>(
      builder: (context, searchProductController, child) {
        return (searchProductController.publishingHouseList != null &&
                searchProductController.publishingHouseList!.isNotEmpty)
            ? Column(
                children: [
                  TitleRowWidget(
                      ...
                      child: Row(
                          children: List<Widget>.generate(
                              searchProductController
                                  .publishingHouseList!.length, (index) {
                        return InkWell(
                          ...
                          onTap: () {
                            ...
                            Provider.of<SearchProductController>(context,
                                    listen: false)
                                .checkedTogglePublishingHouse(index, false,
                                    fromHomePage: true);
                            Provider.of<SearchProductController>(context,
                                    listen: false)
                                .searchProduct(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(searchProductController
