...
import 'package:mstore/features/shop/domain/models/more_store_model.dart';
  ...
  Widget build(BuildContext context) {
    if (widget.moreStore.vacationEndDate != null) {
      ...
      DateTime vacationStartDate =
          DateTime.parse(widget.moreStore.vacationStartDate!);
      final today = DateTime.now();
      final difference = vacationDate.difference(today).inDays;
      final startDate = vacationStartDate.difference(today).inDays;

      if (difference >= 0 &&
          widget.moreStore.vacationStatus! &&
          startDate <= 0) {
        vacationIsOn = true;
      } else {
        vacationIsOn = false;
          ...
          child: Column(children: [
                  ...
                  child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                              image:
                                  '${widget.moreStore.imageFullUrl?.path}'))),
                ),
            ...
            if (widget.moreStore.name?.isNotEmpty ?? false) ...[
              ...
              Center(
                  child: SizedBox(
                width: 70,
                child: Text(widget.moreStore.name ?? '',
                    textAlign: TextAlign.center,
                    maxLines: 1,
