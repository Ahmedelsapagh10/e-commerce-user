...
import 'package:mstore/features/home/widgets/aster_theme/more_store_widget.dart';
...
class _MoreStoreViewState extends State<MoreStoreView> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ShopController>(builder: (context, moreSellerProvider, _) {
      return SingleChildScrollView(
        scrollDirection: Axis.horizontal,
        child: Row(children: [
          for (int i = 0; i < moreSellerProvider.moreStoreList.length; i++)
            SizedBox(
