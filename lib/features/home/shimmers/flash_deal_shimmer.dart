      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Container(
              height: ResponsiveHelper.isTab(context) ? 100 : 70,
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                  height:
                                      ResponsiveHelper.isTab(context) ? 70 : 50,
          ...
          Padding(
              ...
              child: Container(
                  height: ResponsiveHelper.isTab(context) ? 30 : 10,
                  decoration: BoxDecoration(
                  ...
                  child: Shimmer.fromColors(
                      ...
                      child: Column(
                          ...
                          children: [
                            Container(
                                height:
                                    ResponsiveHelper.isTab(context) ? 30 : 10,
                                padding: const EdgeInsets.all(
                                    Dimensions.paddingSizeLarge),
                                decoration: BoxDecoration(
                                    color: ColorResources.iconBg(),
          ...
          CarouselSlider.builder(
            ...
            itemBuilder: (context, index, _) {
              return SizedBox(
                height: ResponsiveHelper.isTab(context) ? 350 : 500,
                child: Container(
                  ...
                  child: Shimmer.fromColors(
                    ...
                    child: Column(
                        ...
                        children: [
                          Container(
                              height:
                                  ResponsiveHelper.isTab(context) ? 300 : 120,
                              padding: const EdgeInsets.all(
                                  Dimensions.paddingSizeLarge),
                              decoration: BoxDecoration(
                                  color: ColorResources.iconBg(),
