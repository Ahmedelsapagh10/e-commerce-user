...
import 'package:mstore/common/basewidget/custom_asset_image_widget.dart';
...
import 'package:mstore/helper/email_checker_helper.dart';
import 'package:mstore/helper/number_checker_helper.dart';
                                ...
                                ? CustomButton(
                                    ...
                                    onTap: () {
                                      ...
                                      if (widget.fromPage == FromPage.login) {
                                        ...
                                        if (config.customerVerification
                                                ?.firebase ==
                                            1) {
                                          authProvider.firebaseOtpLogin(
