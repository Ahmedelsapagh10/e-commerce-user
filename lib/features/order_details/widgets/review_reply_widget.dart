...
class ReviewReplyWidget extends StatefulWidget {
  ...
  const ReviewReplyWidget(
      {super.key, required this.orderDetailsModel, required this.index});
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (orderProvider.orderDetails != null)
                    InkWell(
                      onTap: () async {
                        orderProvider.setOrderReviewExpanded(
                            widget.index,
                            orderProvider
                                    .orderDetails![widget.index].isExpanded!
                                ? false
                                : true);
                        await Provider.of<ReviewController>(context,
                                listen: false)
                            .getOrderWiseReview(
            ...
            widget.orderDetailsModel.isExpanded!
                ? reviewController.isLoading
                    ...
                    : reviewController.orderWiseReview != null
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    reviewController
                                                .orderWiseReview!.createdAt !=
                                            null
                                        ? Text(
                                            DateConverter
                                                .dateTimeStringToMonthDateAndTime(
                                                    reviewController
                                                        .orderWiseReview!
                                                        .createdAt!),
                                            style: textRegular.copyWith(
                                ...
                                ReadMoreText(
                                  ...
                                  trimCollapsedText:
                                      getTranslated('view_moree', context)!,
                                  trimExpandedText:
                                ...
                                if (reviewController.orderWiseReview != null &&
                                    reviewController.orderWiseReview!
                                            .attachmentFullUrl !=
                                        null &&
                                    reviewController.orderWiseReview!
                                        .attachmentFullUrl!.isNotEmpty)
                                  Padding(
                                      padding: const EdgeInsets.symmetric(
                                          vertical:
                                    ...
                                    ? Column(
                                        ...
                                        children: [
                                          ...
                                          ReadMoreText(
                                            ...
                                            colorClickableText:
                                                Theme.of(context).primaryColor,
                                            trimCollapsedText: getTranslated(
                                                'view_moree', context)!,
                                            trimExpandedText: getTranslated(
                                                'view_less', context)!,
                                          ),
                        ...
                        : Text(getTranslated('no_review_found', context)!)
                : const SizedBox(),
          ],
        );
      });
