...
import 'package:mstore/common/basewidget/custom_directionality_widget.dart';
import 'package:mstore/features/auth/enums/from_page.dart';
...
import 'package:mstore/features/order_details/domain/models/order_details_model.dart';
import 'package:mstore/features/order_details/widgets/review_reply_widget.dart';
import 'package:mstore/features/product_details/domain/models/product_details_model.dart';
import 'package:mstore/features/refund/widgets/refund_request_bottom_sheet.dart';
import 'package:mstore/features/review/controllers/review_controller.dart';
import 'package:mstore/features/review/widgets/review_dialog_widget.dart';
import 'package:mstore/features/refund/controllers/refund_controller.dart';
import 'package:mstore/features/refund/widgets/refunded_details_widget.dart';
...
import 'package:mstore/helper/price_converter.dart';
...
import 'package:mstore/features/auth/screens/otp_verification_screen.dart';
...
class _OrderDetailsWidgetState extends State<OrderDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.orderDetailsModel.productDetails != null &&
      ...
      for (DigitalVariation dv
          in widget.orderDetailsModel.productDetails!.digitalVariation ?? []) {
                    ...
                    ClipRRect(
                        ...
                        child: Container(
                            ...
                            child: CustomImageWidget(
                                image:
                                    '${widget.orderDetailsModel.productDetails?.thumbnailFullUrl?.path}',
                                width: 80,
                                height: 80))),
                    const SizedBox(width: Dimensions.marginSizeDefault),
                    Expanded(
                  ...
                  return Padding(
                      ...
                      child: Row(children: [
                        ...
                        Consumer<RefundController>(
                          ...
                          return (widget.orderDetailsModel.order?.status ==
                                      'delivered' &&
  ...
  void _downloadProduct() {
    String url = widget.orderDetailsModel.productDetails!.digitalProductType ==
            'ready_after_sell'
    ...
    String filename = widget
                .orderDetailsModel.productDetails!.digitalProductType ==
            'ready_after_sell'
    ...
    Provider.of<OrderDetailsController>(context, listen: false)
        .productDownload(url: url, fileName: filename, index: widget.index);
  }
}
