...
import 'package:mstore/common/basewidget/rating_bar_widget.dart';
import 'package:mstore/features/chat/screens/chat_screen.dart';
                        ...
                        Container(
                            ...
                            child: ClipRRect(
                                ...
                                child: CustomImageWidget(
                                    image: seller.sellerInfoModel?.seller !=
                                            null
                                              ...
                                              MaterialPageRoute(
                                                  builder: (_) => TopSellerProductScreen(
                                                      ...
                                                      temporaryClose: seller
                                                          ...
                                                          false,
                                                      vacationStatus:
                                                          seller.sellerInfoModel?.seller?.shop?.vacationStatus ??
                                                              false,
                                  ...
                                  Row(children: [
                                    Text(
                                      NumberFormat.compact().format(
                                          seller.sellerInfoModel!.totalProduct),
                                      style: titilliumSemiBold.copyWith(
                                          fontSize:
                                              Dimensions.fontSizeExtraLarge),
                                    ),
                          ...
                          if (seller.sellerInfoModel?.seller != null) {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (_) => TopSellerProductScreen(
                                        sellerId:
                                            seller.sellerInfoModel?.seller?.id,
                                        temporaryClose: seller
                                                .sellerInfoModel
                                                ?.seller
                                                ?.shop
                                        ...
                                        vacationStatus: seller
                                                ...
                                                ?.vacationStatus ??
                                            false,
                                        vacationEndDate: seller.sellerInfoModel
                                        ...
                                        vacationStartDate: seller
                                            ...
                                            ?.shop
                                            ?.vacationStartDate,
                                        name: seller.sellerInfoModel?.seller
                                            ?.shop?.name,
                                        banner: seller.sellerInfoModel?.seller
                                            ?.shop?.bannerFullUrl?.path,
                                        image:
                                            seller.sellerInfoModel?.seller?.shop?.image)));
                          } else {
