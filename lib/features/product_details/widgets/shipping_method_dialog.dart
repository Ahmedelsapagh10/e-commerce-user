...
class ChooseShippingMethodDialog extends StatefulWidget {
  ...
  final Function(BuildContext context, CartModel cart, double shippingCost)
      callback;

  const ChooseShippingMethodDialog(this.shippingMethodList, this.cart,
      this.choices, this.variationIndexes, this.callback,
      {super.key});
