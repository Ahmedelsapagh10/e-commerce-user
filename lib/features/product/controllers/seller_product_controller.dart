...
import 'package:mstore/features/shop/domain/models/shop_again_from_recent_store_model.dart';
...
class SellerProductController extends ChangeNotifier {
  ...
  Future<ApiResponse> getSellerProductList(
    ...
    print("=====ProductType==SellerRepo===>>${productType}");
  ...
  Future<void> getShopAgainFromRecentStore() async {
    ApiResponse apiResponse =
        await sellerProductServiceInterface!.getShopAgainFromRecentStoreList();
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
