...
class _MaintenanceScreenState extends State<MaintenanceScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final ConfigModel? configModel =
        Provider.of<SplashController>(context).configModel;
    Provider.of<SplashController>(context, listen: false)
        ...
        body: Padding(
          ...
          child: Center(
            child:
              ...
              if (configModel?.maintenanceModeData?.maintenanceMessages
                          ?.maintenanceMessage !=
                      null &&
                  configModel!.maintenanceModeData!.maintenanceMessages!
              ...
              if (configModel?.maintenanceModeData?.maintenanceMessages
                ...
                Text(
                  getTranslated('maintenance_title', context)!,
                  style: titilliumBold.copyWith(
                      fontSize: Dimensions.fontSizeLarge,
                      color: Theme.of(context).textTheme.bodyLarge!.color),
                  textAlign: TextAlign.center,
              ...
              if (configModel?.maintenanceModeData?.maintenanceMessages
                  ...
                  (configModel?.maintenanceModeData?.maintenanceMessages
                      ...
                      configModel!.maintenanceModeData!.maintenanceMessages!
                          .messageBody!.isEmpty)) ...[
                Text(getTranslated('maintenance_body', context)!,
