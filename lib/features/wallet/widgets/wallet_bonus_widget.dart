...
import 'package:mstore/features/home/shimmers/wallet_bonus_shimmer.dart';
...
class WalletBonusWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        padding:
            const EdgeInsets.only(top: Dimensions.paddingSizeSmall, bottom: 50),
        child:
            Consumer<WalletController>(builder: (context, walletProvider, _) {
          return walletProvider.walletBonusModel != null
              ? (walletProvider.walletBonusModel!.bonusList != null &&
                      walletProvider.walletBonusModel!.bonusList!.isNotEmpty)
                      ...
                      ClipRRect(
                          ...
                          child: CarouselSlider.builder(
                            ...
                            itemCount: walletProvider
                                .walletBonusModel?.bonusList?.length,
                                          ...
                                          children: [
                                            ...
                                            if (walletProvider
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                    '${getTranslated('valid_till', context)} '
                                                ...
                                                ? Padding(
                                                    padding: const EdgeInsets
                                                        ...
                                                        vertical: Dimensions
                                                            .paddingSizeSmall),
                                                    child: Text(
                                                        '${getTranslated('add_fund_to_wallet', context)} '
                          ...
                          child: Center(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    width: index == walletProvider.currentIndex
                                        ? Dimensions.radiusDefault
                                        : Dimensions.radiusSmall,
                                    height: index == walletProvider.currentIndex
                                        ? Dimensions.radiusDefault
                                        : Dimensions.radiusSmall,
                                    margin: const EdgeInsets.symmetric(
