...
import 'package:mstore/features/loyaltyPoint/widget/how_to_use_dialog_widget.dart';
...
class LoyaltyPointConverterDialogueWidget extends StatefulWidget {
  ...
  @override
  State<LoyaltyPointConverterDialogueWidget> createState() =>
      _LoyaltyPointConverterDialogueWidgetState();
}

class _LoyaltyPointConverterDialogueWidgetState
    extends State<LoyaltyPointConverterDialogueWidget> {
  ...
  Widget build(BuildContext context) {
    double? exchangeRate = Provider.of<SplashController>(context, listen: false)
        .configModel!
        .loyaltyPointExchangeRate;
    int? min = Provider.of<SplashController>(context, listen: false)
        .configModel!
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          PointWithTextWidget(
                              pointColor: ColorResources.getTextTitle(context),
                              text:
                                  '$exchangeRate ${getTranslated('note_point_two', context)} '
