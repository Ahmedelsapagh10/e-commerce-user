...
class SelectCurrencyBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<SelectCurrencyBottomSheetWidget> createState() =>
...
class _SelectCurrencyBottomSheetWidgetState
  ...
  void initState() {
    selectedIndex =
        Provider.of<SplashController>(context, listen: false).currencyIndex!;
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<SplashController>(builder: (context, currencyProvider, _) {
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return currencyProvider
                                  .configModel?.currencyList![index].status ==
                              false
                          ? const SizedBox()
                          : InkWell(
                              onTap: () {
