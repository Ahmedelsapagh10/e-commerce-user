...
import 'package:mstore/common/basewidget/no_internet_screen_widget.dart';
...
import 'package:mstore/features/cart/widgets/cart_page_shimmer_widget.dart';
import 'package:mstore/features/cart/widgets/cart_widget.dart';
import 'package:mstore/features/checkout/screens/checkout_screen.dart';
import 'package:mstore/features/shipping/widgets/shipping_method_bottom_sheet_widget.dart';
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    for (int index = 0;
                                        index < sellerGroupList.length;
                                        index++) {
                                      if (sellerGroupList[index].quantity! >
                                              sellerGroupList[index]
                                                  .productInfo!
                                                  .totalCurrentStock! &&
                                          sellerGroupList[index].productType ==
                                              "physical") {
