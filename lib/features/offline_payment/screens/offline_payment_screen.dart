...
import 'package:mstore/features/offline_payment/domain/models/offline_payment_model.dart';
...
import 'package:mstore/features/offline_payment/widgets/offline_card_widget.dart';
                ...
                child: CustomButton(
                  ...
                  onTap: () {
                    if (offlineFormKey.currentState?.validate() ?? false) {
                      ...
                      String billingAddressId = (Provider.of<SplashController>(
                                      context,
                                      listen: false)
                                  .configModel!
