...
class RefundService implements RefundServiceInterface {
  ...
  @override
  Future refundRequest(int? orderDetailsId, double? amount, String refundReason,
      List<XFile?> file) async {
    return await refundRepositoryInterface.refundRequest(
        orderDetailsId, amount, refundReason, file);
  }
}
