...
import 'package:mstore/features/chat/widgets/conversation_tabview.dart';
...
import 'package:mstore/features/chat/widgets/chat_item_widget.dart';
import 'package:mstore/features/chat/widgets/inbox_shimmer_widget.dart';
import 'package:mstore/features/chat/widgets/search_inbox_widget.dart';
...
class _InboxScreenState extends State<InboxScreen>
  ...
  void initState() {
    ...
    if (!isGuestMode) {
      load();
      _tabController =
          TabController(vsync: this, length: 2, initialIndex: widget.initIndex);
    }
    if (widget.fromNotification) {
      Provider.of<ChatController>(context, listen: false)
          .setUserTypeIndex(context, widget.initIndex, isUpdate: false);
      Provider.of<ChatController>(context, listen: false)
                ...
                child: isGuestMode
                    ? NotLoggedInWidget(
                        message: getTranslated(
                            'to_communicate_with_vendors', context))
                    : RefreshIndicator(onRefresh: () async {
                        searchController.clear();
                        await chat.getChatList(1,
                            userType: _tabController.index);
