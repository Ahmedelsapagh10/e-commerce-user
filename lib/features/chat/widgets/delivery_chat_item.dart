...
class DeliveryChatItemWidget extends StatefulWidget {
  ...
  const DeliveryChatItemWidget(
      {super.key, this.chat, required this.chatProvider});
  ...
  void initState() {
    ...
    image = widget.chatProvider.userTypeIndex == 0
        ? widget.chat!.sellerInfo != null
            ? widget.chat!.sellerInfo?.shops![0].imageFullUrl?.path
            : ''
        : widget.chat!.deliveryMan?.imageFullUrl?.path ?? '';
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                              DateConverter.inboxLocalDateToIsoStringAMPM(
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Text(widget.chat!.message ?? 'Attachment',
                                maxLines: 2,
