...
class SupportTicketReplyWidget extends StatelessWidget {
  ...
  const SupportTicketReplyWidget(
      {super.key,
      required this.isMe,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (replyModel.attachmentFullUrl != null &&
            replyModel.attachmentFullUrl!.isNotEmpty)
          const SizedBox(height: Dimensions.paddingSizeSmall),
        (replyModel.attachmentFullUrl != null &&
                replyModel.attachmentFullUrl!.isNotEmpty)
            ? Padding(
                      ...
                      return InkWell(
                        onTap: () => showDialog(
                            ...
                            builder: (ctx) => ImageDialog(
                                imageUrl:
                                    '${replyModel.attachmentFullUrl?[attachmentIndex].path}')),
                        child: ClipRRect(
