...
class SupportTicketService implements SupportTicketServiceInterface {
  ...
  @override
  Future createNewSupportTicket(
      SupportTicketBody supportTicketModel, List<XFile?> file) async {
    return await supportTicketRepositoryInterface.createNewSupportTicket(
        supportTicketModel, file);
  }
  ...
  Future sendReply(String ticketID, String message, List<XFile?> file) async {
    return await supportTicketRepositoryInterface.sendReply(
        ticketID, message, file);
  }
}
